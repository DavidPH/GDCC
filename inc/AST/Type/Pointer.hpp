   ...
   namespace AST
   {
      ...
      class Type_PtrBase : public Type
      {
         GDCC_Core_CounterPreambleAbstract(
            GDCC::AST::Type_PtrBase, GDCC::AST::Type);
      ...
      class Type_Pointer final : public Type_PtrBase
      {
         GDCC_Core_CounterPreamble(
            GDCC::AST::Type_Pointer, GDCC::AST::Type_PtrBase);
      ...
      {
         GDCC_Core_CounterPreamble(
            GDCC::AST::Type_RefL, GDCC::AST::Type_PtrBase);
      ...
      {
         GDCC_Core_CounterPreamble(
            GDCC::AST::Type_RefR, GDCC::AST::Type_PtrBase);
