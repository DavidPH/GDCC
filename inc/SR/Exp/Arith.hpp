...
#ifndef GDCC__SR__Exp__Arith_H__
#define GDCC__SR__Exp__Arith_H__
...
//
// GDCC_SR_Exp_ArithPreamble
//
// Performs common declarations for all arithmetic base classes.
//
#define GDCC_SR_Exp_ArithPreamble(class) \
   GDCC_Core_CounterPreambleAbstract( \
      GDCC::SR::class, GDCC::SR::Exp_Binary); \
   \
protected: \
