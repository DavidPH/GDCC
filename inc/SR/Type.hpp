...
//-----------------------------------------------------------------------------
//
// Source Representation expression type handling.
//
//-----------------------------------------------------------------------------

#ifndef GDCC__SR__Type_H__
#define GDCC__SR__Type_H__
...
// GDCC_SR_Type_Insert
//
#define GDCC_SR_Type_Insert(name) \
   if(base->name##Type) \
   { \
...
// GDCC_SR_Type_Unlink
//
#define GDCC_SR_Type_Unlink(name) \
...
namespace GDCC::SR
{
   ...
   {
   public:
      virtual char const *what() const noexcept {return "SR::TypeError";}
   };
   ...
   class Type : public Core::Counter
   {
      GDCC_Core_CounterPreambleAbstract(
         GDCC::SR::Type, GDCC::Core::Counter);
   ...
   class TypeSet final : public Core::CounterBase
   {
      GDCC_Core_CounterPreambleNoVirtual(
         GDCC::SR::TypeSet, GDCC::Core::CounterBase);
