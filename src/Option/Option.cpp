...
// CountArgs
//
static GDCC::Option::uint CountArgs(GDCC::Option::uint argc,
   GDCC::Option::strv argv)
{
   for(GDCC::Option::uint argi = 0; argi != argc; ++argi)
   {
...
// WordLength
//
static GDCC::Option::uint WordLength(char const *str)
{
   GDCC::Option::uint len = 0;
...
// WriteWrapped
//
static void WriteWrapped(std::ostream &out, GDCC::Option::uint width,
   char const *str, GDCC::Option::uint baselen, char const *prefix = nullptr)
{
   GDCC::Option::uint linelen = baselen;
