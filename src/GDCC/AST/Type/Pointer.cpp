...
namespace GDCC
{
   namespace AST
   {
      ...
      //
      FastU Type_PtrBase::getSizeAlign() const
      {
      ...
      //
      FastU Type_PtrBase::getSizeBytes() const
      {
      ...
      //
      FastU Type_PtrBase::getSizePoint() const
      {
      ...
      //
      FastU Type_PtrBase::getSizeShift() const
      {
      ...
      //
      FastU Type_PtrBase::getSizeWords() const
      {
