...
namespace GDCC
{
   namespace AST
   {
      ...
      //
      Type::CRef Type::getTypeBitfield(FastU bitsF, FastU bitsI, FastU bitsO) const
      {
      ...
      //
      Type_Bitfield::Type_Bitfield(Type const *base_, FastU bitsF_,
         FastU bitsI_, FastU bitsO_) : Super{base_}, bitsF{bitsF_},
         bitsI{bitsI_}, bitsO{bitsO_}
      {
