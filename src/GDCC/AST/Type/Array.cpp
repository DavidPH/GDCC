...
namespace GDCC
{
   namespace AST
   {
      ...
      // Type::getTypeArray
      //
      Type::CRef Type::getTypeArray(FastU size) const
      {
      ...
      //
      Type_Array::Type_Array(Type const *base_, FastU size_) : Super{base_}, size{size_}
      {
      ...
      {
         return IR::Type_Multi(Array<IR::Type>(size, base->getIRType()));
      }

      //
      // Type_Array::getSizeBytes
      //
      FastU Type_Array::getSizeBytes() const
      {
