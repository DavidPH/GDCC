...
namespace GDCC
{
   namespace AST
   {
      ...
      {
         GDCC_CounterPreamble(GDCC::AST::Exp_ValueArg, GDCC::AST::Exp);

      public:
         Arg const arg;


         friend Exp::CRef ExpCreate_ValueArg(Arg const &arg, Origin pos);

      protected:
         Exp_ValueArg(Arg const &arg, Origin pos);
