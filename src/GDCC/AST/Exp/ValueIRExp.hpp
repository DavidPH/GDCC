...
namespace GDCC
{
   namespace AST
   {
      ...
      {
         GDCC_CounterPreamble(GDCC::AST::Exp_ValueIRExp, GDCC::AST::Exp);
      ...
      public:
         ...
         friend Exp::CRef ExpCreate_ValueIRExp(IR::Exp const *exp, Type const *type);
         friend Exp::CRef ExpCreate_ValueIRExp(IR::Exp const *exp, Type const *type, Origin pos);

      protected:
         Exp_ValueIRExp(IR::Exp const *exp, Type const *type, Origin pos);
