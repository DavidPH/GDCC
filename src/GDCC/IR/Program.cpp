...
//
template<typename T>
static T *FindTable(GDCC::IR::Program::Table<T> &table, GDCC::String glyph)
{
...
static T &GetTable(GDCC::IR::Program::Table<T> &table, GDCC::String glyph, Args &&...args)
{
   auto itr = table.find(glyph);
...
//
template<typename T>
static GDCC::IR::Program::TableRange<T> RangeTable(GDCC::IR::Program::Table<T> &table)
{
...
namespace GDCC
{
   namespace IR
   {
      ...
      //
      Program::Program() :
         spaceGblReg{AddrSpace(AddrBase::GblReg, STR_)},
         spaceLocArs{AddrSpace(AddrBase::LocArs, STR_)},
         spaceMapReg{AddrSpace(AddrBase::MapReg, STR_)},
         spaceWldReg{AddrSpace(AddrBase::WldReg, STR_)}
      {
      }
      ...
      //
      Function *Program::findFunction(String glyph)
      {
      ...
      //
      GlyphData *Program::findGlyphData(String glyph)
      {
      ...
      // Program::findImport
      //
      Import *Program::findImport(String glyph)
      {
      ...
      // Program::findObject
      //
      Object *Program::findObject(String glyph)
      {
      ...
      // Program::findStrEnt
      //
      StrEnt *Program::findStrEnt(String glyph)
      {
      ...
      //
      StrEnt *Program::findStrEntVal(String value)
      {
      ...
      // Program::getFunction
      //
      Function &Program::getFunction(String glyph)
      {
      ...
      //
      GlyphData &Program::getGlyphData(String glyph)
      {
      ...
      // Program::getImport
      //
      Import &Program::getImport(String glyph)
      {
      ...
      // Program::getObject
      //
      Object &Program::getObject(String glyph)
      {
      ...
      //
      Space &Program::getSpaceGblArr(String glyph)
      {
      ...
      //
      Space &Program::getSpaceMapArr(String glyph)
      {
      ...
      //
      Space &Program::getSpaceWldArr(String glyph)
      {
      ...
      // Program::getStrEnt
      //
      StrEnt &Program::getStrEnt(String glyph)
      {
      ...
      IArchive &operator >> (IArchive &in, Program &out)
      {
         ...
         // tableSpace*
         auto getSpace = [&](AddrBase base, Space &(Program::*getter)(String))
         {
