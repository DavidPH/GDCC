   ...
   block
{
   ...
   Jcnd_Tab  1, Stk(), Lit(0x00000000), Lit(:"$retr")
   Jcnd_Tab  1, Stk(), Lit(0x7F800000), Lit(:"$retr")
   CmpI_GT_W 1, Stk(), Stk(), Lit(0x7F800000)
   Jcnd_Tru  1, Stk(), Lit(:"$retr")
   Move_W    1, Stk(), LocReg(Lit(0))
   Jcnd_Tab  1, Stk(), Lit(0x00000000), Lit(:"$retl")
   Jcnd_Tab  1, Stk(), Lit(0x7F800000), Lit(:"$retl")
   Move_W    1, Nul(), Stk()
   ...
   block
{
   ...
   Jcnd_Tab  1, Stk(), Lit(0x00000000), Lit(:"$retr")
   Jcnd_Tab  1, Stk(), Lit(0x7FF00000), Lit(:"$retr")
   CmpI_GT_W 1, Stk(), Stk(), Lit(0x7FF00000)
   Jcnd_Tru  1, Stk(), Lit(:"$retr")
   Move_W    1, Stk(), LocReg(Lit(1))
   Jcnd_Tab  1, Stk(), Lit(0x00000000), Lit(:"$retl")
   Jcnd_Tab  1, Stk(), Lit(0x7FF00000), Lit(:"$retl")
   Move_W    1, Nul(), Stk()
